...
{
    if($clsadmin->admin_login($_REQUEST['admin_name'], $_REQUEST['admin_pwd']) == false) {
        $error='用户名或密码错误!';
    } else {
...
<body>
    <form action="admin_login.php" method="post">
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr><td width="50%" align="right">用户名：</td><td align="left"><input type="text" name="admin_name"/></td></tr>
            <tr><td width="50%" align="right">密码：</td><td align="left"><input type="password" name="admin_pwd"/></td></tr>
